...
\begin{figure}[H]
  \center
  \begin{tikzpicture}
    \begin{scope}[xscale=0.8,yscale=0.15]
      \tkzDefPoint(-5,0){U}
      \tkzDefPoint(-1,4){A}
      \tkzDefPoint(6,11){A'}
      \tkzDefPoint(1,0){B}
...
\begin{figure}[H]
    \begin{center}
        \begin{tikzpicture}
            \begin{scope}[xscale=0.8, yscale=0.8]
                \tkzDefPoint(-2,0.7){P}
                \tkzDefPoint(-1.3,1.3){R}
                \tkzDefPoint(2.5,3){O}
                \tkzDefPoint(1,1){P*Q}
                \tkzDefPoint(0.4,0.8){R*Q}
                \tkzDefPoint(1.5,-1.8){F}
                \tkzInterLL(P,P*Q)(R,R*Q) \tkzGetPoint{Q}
                \tkzInterLL(P,F)(O,R*Q) \tkzGetPoint{R+Q}
                \tkzInterLL(R,F)(O,P*Q) \tkzGetPoint{P+Q}
                \tkzDrawPoints[black](O,P,Q,P*Q,P+Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.3 and 1.5,dashed](P,Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.5 and 1](O,P*Q)
                \tkzLabelPoint[black, above left](O){$O$}
                \tkzLabelPoint[black, below left](P){$P$}
                \tkzLabelPoint[black, above](Q){$Q$}
                \tkzLabelPoint[black, below right](P*Q){$P*Q$}
                \tkzLabelPoint[black, right](P+Q){$P+Q$}

                \draw[line width=0.7pt, smooth] (2.9,3.7) -- (O)
                    .. controls (1.7,1.8) .. (P*Q)
                    .. controls (0.7,0.8) .. (R*Q)
                    .. controls (0.23,0.82) .. (Q)
                    .. controls (-0.4,1.1) and (-0.8,1.3) .. (R)
                    .. controls (-1.5,1.25) and (-1.8,1.2) .. (P)
                    .. controls (-2.2,-0.5) and (-1,-0.4) .. (R+Q)
                    .. controls (-0.35,-0.23) and (-0.25,-0.22) .. (P+Q)
                    .. controls (0.9,-0.25) and (1.2,-0.9) .. (F)
                    -- (1.6,-2.2);
            \end{scope}
        \end{tikzpicture}
    \end{center}
    \caption{Group law for cubics}
\end{figure}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{scope}[xscale=1.5, yscale=1.5]
                ...
                \tkzInterLL(P,F)(O,R*Q) \tkzGetPoint{R+Q}
                \tkzInterLL(R,F)(O,P*Q) \tkzGetPoint{P+Q}
                \tkzDrawPoints[black](O,F,P,Q,R,P*Q,R*Q,P+Q,R+Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.3 and 1.5,dashed](P,Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.5 and 2](R,Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.5 and 1,dashed](O,R*Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.5 and 1](O,P*Q)
                \tkzDrawLine[black, line width=0.5pt, add=0.2 and 0.1,dashed](R,F)
                \tkzDrawLine[black, line width=0.5pt, add=0.1 and 0.1](P,F)
                \tkzLabelPoint[black, above left](O){$O$}
                \tkzLabelPoint[black, below left](P){$P$}
                \tkzLabelPoint[black, above](R){$R$}
                \tkzLabelPoint[black, above](Q){$Q$}
                \tkzLabelPoint[black, below right](P*Q){$P*Q$}
                \tkzLabelPoint[black, below](R*Q){$Q*R$}
                \tkzLabelPoint[black, above right](P+Q){$P+Q$}
                \tkzLabelPoint[black, below left](R+Q){$Q+R$}
                \tkzLabelPoint[black, below left](F){$P*(Q+R)=(P+Q)*R$}
                \tkzLabelPoint[black, above right](F){$T$}
