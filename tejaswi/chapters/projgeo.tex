...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzDefPoint(1.13,0){P}
    \tkzDefPoint(-1.13,0){R}
    \tkzDrawEllipse[line width=1, black](Q,3,2,0)
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \tkzDefPoint(0,0){C}
    \tkzDefPoint(0,{sqrt(3)}){P}
    \tkzDefPoint(-2,1){Q}
    \tkzDefPoint(2.1339745962,2.5131397208){R}
    \tkzDefPoint(2.1339745962,-2.5131397208){R'}
    \tkzDefPoint(0,2.5){y}
    \tkzDefPoint(0,-2.5){y'}
    \tkzDefPoint(3,0){x}
    \tkzDefPoint(-2.25,0){x'}
    \tkzDefPoint(-2.1037979125,0){E}
    \tkzDrawPoints[fill=black](E,P,Q,R,R')
    \tkzDrawLine[<->, line width=0.5, gray](y,y')
    \tkzDrawLine[<->, line width=0.5, gray](x,x')
    \tkzDrawLine[<->, line width=1, add=1.5 and 0.5,black](P,Q)
    \draw[domain=-2.1037979125:2.25, smooth, line width=1, black]
      plot (\x,{sqrt((\x)^3-3*\x+3))});
    \draw[domain=-2.1037979125:2.25, smooth, line width=1, black]
      plot (\x,{-sqrt((\x)^3-3*\x+3))});
    \tkzLabelPoints[above right, black](P)
    \tkzLabelPoints[above left, black](Q)
    \tkzLabelPoints[below right, black](R)
    \tkzLabelPoints[above right, black](R')
  \end{tikzpicture}
  \caption{ Elliptic curve in $E$ in Weirestrass form}
\end{figure}
